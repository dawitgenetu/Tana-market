...
import { ShoppingCart, User, Menu, X, Package, LayoutDashboard, Bell, ChevronDown } from 'lucide-react';
...
export default function Navigation() {
  ...
  return (
    <motion.nav
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="sticky top-0 z-50 backdrop-blur-xl bg-white/70 border-b border-white/20 shadow-sm supports-[backdrop-filter]:bg-white/60"
    >
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {user && (
              <>
                ...
                <Link to="/dashboard" className="text-gray-700 hover:text-blue-600 transition-colors font-medium flex items-center gap-1">
          ...
          <div className="px-4 py-4 space-y-3">
            ...
            {user && (
              <>
                ...
                <Link to="/dashboard" className="block py-2 text-gray-700 hover:text-blue-600 font-medium">
                  Dashboard
                </Link>
              </>
            )}
